...
![image](https://ws2.sinaimg.cn/large/80ceacb8ly1fzokmrh2u3j211s0eu3zx.jpg)
...
1. Collection接口中有一个方法，`iterator()`，这个方法返回的就是迭代器的实现类对象
...
![image](https://wx1.sinaimg.cn/large/80ceacb8ly1fzolk7k3ckj211s0eumyf.jpg)
